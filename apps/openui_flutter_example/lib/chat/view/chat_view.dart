                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Your key is stored only in temporary memory '
                              '(RAM) to enable Live chat for this session. '
                              'It is never saved to any servers, local '
                              'storage, or your device disk, and is '
                              'completely destroyed when the app closes '
                              'or restarts.',
